...
if(isset($_POST['email']) || isset($_POST['senha']) || isset($_POST['nome'])) {
  ...
  $cadastrar=mysqli_query($mysqli, "INSERT INTO usuario (nome, email, senha, telefone, redesocial) VALUES ('$nome','$email','$passw', '$telefone', '$redesocial')");
        ...
        <div class="container-form">
            <div class="form-content">
                ...
                <form action="" name="email" method="post">
                    ...
                    <input type="email" name="email" id="email" placeholder="EstoqueRemedios@gmail.com">
                    
                    <label for="senha">Senha</label>
                    <input type="password" name="senha" id="senha" placeholder="*********">

                    <label for="telefone">Telefone</label>
                    <input type="text" name="telefone" id="telefone" placeholder="8199999999">

                    <label for="redesocail">Rede Social</label>
                    <input type="text" name="redesocail" id="redesocial" placeholder="@brunowlian">
